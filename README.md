...
- **[startup-ideas](skills/startup-ideas/SKILL.md)** — generate and evaluate startup ideas with Paul Graham's framework: outcome = growth rate × duration, growth from users loving the product enough to tell friends (empathy, not exploitation), and finding ideas by building cool things with friends. Adapted from his essay "How to Earn a Billion Dollars."
